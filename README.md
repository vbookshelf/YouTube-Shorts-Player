...
- Over time, the source of toxic techniques may be the video creators themselves. The algorithms are vey effective at optimizing for engagement. Creators may start using the same playbook. An ad-free, non-algorithmic feed won't escape that.
